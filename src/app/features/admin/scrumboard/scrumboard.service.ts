...
export class ScrumboardService
{
     ...
     * Getter for board
     */
    get board$(): Observable<DiscipleshipProgramSummary>
    {
     ...
     * Getter for boards
     */
    get boards$(): Observable<DiscipleshipProgramSummary[]>
    {
     ...
     * Get boards
     */
    getBoards(): Observable<DiscipleshipProgramSummary[]>
    {
        return this._httpClient.get<ApiResponse>(`${this._apiUrl}/v1/discipleship/programs`).pipe(
            map(response => response.data as DiscipleshipProgramSummary[]),
     ...
     * @param id
     */
    getBoard(id: number): Observable<DiscipleshipProgramSummary>
    {
        return this._httpClient.get<ApiResponse>(`${this._apiUrl}/v1/discipleship/programs/${id}`).pipe(
            map(response => response.data as DiscipleshipProgramSummary),
